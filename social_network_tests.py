...
def test_recommend_by_number_of_common_friends(practice_graph, rj):
    assert_equals(['D', 'F'],
                  sn.rec_number_common_friends(practice_graph,
                                                           "A"))
    assert_equals(['Capulet', 'Montague', 'Benvolio',
                   'Friar Laurence', 'Juliet'],
                  sn.rec_number_common_friends(rj, "Mercutio"))
...
def main_test():
    ...
    test_number_of_common_friends_map(practice_graph, rj)
    test_number_map_to_sorted_list()
    test_recommend_by_number_of_common_friends(practice_graph, rj)
