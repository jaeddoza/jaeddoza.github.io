...
def classify(gc_content):
    ...
    if gc_content > 0.56:
        ...
        if gc_content < 0.36:
            ...
            if gc_content <= 0.56 and gc_content >= 0.36:
                return "moderate GC content"
    # This statement is a placeholder. For Problem 6, replace it with your
...
print('Sum of G+C+A+T counts:', sum_count)
print('Total count:', total_count)
print('Length of nucleotides:', len_nuc)
print('AT/GC Ratio:', acdc_ratio)
